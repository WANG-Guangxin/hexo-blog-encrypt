...
var mmdjs = document.createElement('script');
mmdjs.src = 'https://npm.elemecdn.com/mermaid/dist/mermaid.min.js';
document.head.appendChild(mmdjs);
    ...
    mainElement.addEventListener('keydown', async (event) => {
      if (event.isComposing || event.keyCode === 13) {
        ...
        decrypt(decryptKey, iv, hmacKey).then((result) => {
          ...
          import mermaid from 'https://npm.elemecdn.com/mermaid/dist/mermaid.min.js';
          mermaid.initialize();
          if (result) {
